...
import { 
  ...
  ChevronDown, ArrowRight, Zap, Award, Users
} from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    id: 'service-ac',
    image: 'https://images.unsplash.com/photo-1631548484110-466049029471?auto=format&fit=crop&q=80&w=400'
  }
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 selection:bg-orange-100 selection:text-orange-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3 cursor-pointer group" onClick={() => scrollToSection('hero')}>
              <div className="bg-navy-900 p-2.5 rounded-2xl group-hover:rotate-12 transition-transform duration-300 shadow-lg shadow-navy-900/20">
                <Wrench className="w-6 h-6 text-orange-500" />
              </div>
              <span className="text-2xl font-bold tracking-tight">
                <span className="text-navy-900">A to Z</span> <span className="text-orange-500">Service</span>
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="tel:+919582194041" className="orange-gradient text-white px-7 py-3 rounded-2xl font-bold transition-all shadow-xl shadow-orange-500/30 flex items-center gap-2 transform hover:-translate-y-1 hover:shadow-orange-500/40">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              <a href="tel:+919582194041" className="block w-full orange-gradient text-white text-center px-6 py-5 rounded-2xl font-black shadow-xl shadow-orange-500/20 text-lg">
                Call Now: +91 95821 94041
              </a>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      {/* Hero Section */}
      <section id="hero" className="relative pt-32 pb-20 md:pt-56 md:pb-40 overflow-hidden">
            ...
            >
              <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-2xl shadow-sm mb-8">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map(i => <img key={i} src={`https://i.pravatar.cc/100?u=${i+10}`} className="w-7 h-7 rounded-full border-2 border-white shadow-sm" />)}
                </div>
      ...
      <div className="py-12 bg-slate-50 border-y border-slate-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 mb-8">
          <p className="text-center text-xs font-black text-slate-400 uppercase tracking-[0.3em]">We Service All Major Brands</p>
        </div>
        <div className="flex animate-marquee whitespace-nowrap">
          {[
            'SAMSUNG', 'LG', 'WHIRLPOOL', 'HAIER', 'BOSCH', 'GODREJ', 'VOLTAS', 'HITACHI', 'DAIKIN', 'PANASONIC',
            'SAMSUNG', 'LG', 'WHIRLPOOL', 'HAIER', 'BOSCH', 'GODREJ', 'VOLTAS', 'HITACHI', 'DAIKIN', 'PANASONIC'
          ].map((brand, i) => (
            <span key={i} className="text-3xl md:text-5xl font-black text-slate-200 mx-12 hover:text-orange-500/20 transition-colors cursor-default">
              {brand}
            </span>
          ))}
        </div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="h-64 overflow-hidden relative">
                  <img src={service.image} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" referrerPolicy="no-referrer" />
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  <img src="https://images.unsplash.com/photo-1558403194-611308249627?auto=format&fit=crop&q=80&w=400" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                </motion.div>
                <motion.div 
                  whileHover={{ scale: 1.02 }}
                ...
                <motion.div 
                  ...
                  className="bg-slate-100 h-80 rounded-[3rem] overflow-hidden shadow-sm"
                >
                  <img src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80&w=400" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                </motion.div>
              </div>
            ...
            <div>
              <h2 className="text-orange-500 font-black uppercase tracking-[0.25em] text-sm mb-4">About A to Z Service</h2>
              <h3 className="text-4xl md:text-6xl font-extrabold text-navy-900 mb-8 tracking-tight leading-tight">Gurgaon's Most Trusted Repair Partner</h3>
              <p className="text-xl text-slate-600 mb-10 leading-relaxed font-medium">
                Founded in 2016, A to Z Service started with a simple mission: to provide honest, high-quality appliance repair services to the residents of Gurgaon. Today, we are proud to be the first choice for thousands of families.
              </p>
          ...
          <div className="bg-navy-900 rounded-[4rem] p-12 md:p-24 text-center relative overflow-hidden shadow-3xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button onClick={() => scrollToSection('contact')} className="orange-gradient hover:shadow-orange-500/40 text-white px-12 py-6 rounded-[2rem] font-black text-xl shadow-2xl transition-all transform hover:-translate-y-1">
                  Book A Visit Now
                </button>
                <a href="tel:+919582194041" className="glass-dark hover:bg-white/10 text-white px-12 py-6 rounded-[2rem] font-black text-xl transition-all flex items-center justify-center gap-3">
                ...
                <div className="space-y-12 relative z-10">
                  <div className="flex items-start gap-8 group">
                    ...
                    <div>
                      ...
                      <a href="tel:+919582194041" className="text-2xl md:text-4xl font-black hover:text-orange-400 transition-colors tracking-tight">+91 95821 94041</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-8 group">
                    ...
                    <div>
                      ...
                      <p className="text-2xl md:text-4xl font-black tracking-tight">Sector 52, Wazirabad, Gurgaon</p>
                    </div>
                  </div>
      ...
      <footer className="bg-white py-24 border-t border-slate-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-10">
                ...
                <span className="text-3xl font-black tracking-tighter text-navy-900">
                  A to Z <span className="text-orange-500">Service</span>
                </span>
              </div>
              <p className="text-slate-500 text-xl max-w-md leading-relaxed font-medium">
                Gurgaon's leading home appliance repair service provider. We offer expert solutions for refrigerators, washing machines, and air conditioners with a commitment to quality and customer satisfaction.
              </p>
            </div>
          ...
          <div className="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-slate-500 font-black text-sm">© 2026 A to Z Service. All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      <motion.a 
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 md:hidden orange-gradient text-white p-6 rounded-[2.5rem] shadow-[0_20px_40px_-10px_rgba(249,115,22,0.5)] z-50 flex items-center gap-3"
      >
        <Phone className="w-6 h-6" />
        <span className="font-black uppercase tracking-widest text-sm">Call Now</span>
      </motion.a>
    </div>
  );
}
