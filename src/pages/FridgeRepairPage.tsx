...
export default function FridgeRepairPage() {
  ...
  useEffect(() => {
    document.title = "Fridge Repair Gurgaon | Refrigerator Gas Refill & Compressor Service (₹249)";
    ...
    canonical.href = "https://www.gurgaonacservice.com/fridge-repair-gurgaon";

    // Service Schema
    const script = document.createElement('script');
    script.type = 'application/ld+json';
    script.id = 'fridge-service-schema';
    script.text = JSON.stringify({
      ...
      "areaServed": "Gurgaon",
      "url": "https://www.gurgaonacservice.com/fridge-repair-gurgaon",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
        "price": "249",
    ...
    return () => {
      const el = document.getElementById('fridge-service-schema');
      if (el) el.remove();
    };
  }, []);
